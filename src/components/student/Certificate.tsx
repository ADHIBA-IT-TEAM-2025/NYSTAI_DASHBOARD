    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
            ...
            <div className="bg-white p-6 shadow-md rounded w-full max-w-lg text-center">
                <p className="mb-4">Congratulations, {certificate.name}!</p>
                <p className="mb-4">You have completed the course: {certificate.courseName}</p>
                <p className="text-gray-500">Date of Completion: {certificate.date}</p>
            </div>
        </div>
    );
}
