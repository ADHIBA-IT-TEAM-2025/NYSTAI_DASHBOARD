...
export default function CourseDetail() {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (updatedRes.ok) {
                const updatedCourse: Course = await updatedRes.json();
...
// ✅ Props type for FileUploadBox
interface FileUploadBoxProps {
    selectedFile: File | null;
    setSelectedFile: React.Dispatch<React.SetStateAction<File | null>>;
}

function FileUploadBox({ selectedFile, setSelectedFile }: FileUploadBoxProps) {
    ...
    return (
        <div
            {...getRootProps()}
            className={`transition border border-gray-300 border-dashed cursor-pointer dark:hover:border-brand-500 dark:border-gray-700 rounded-xl hover:border-brand-500 h-[200px] ${isDragActive
        ...
        >
            ...
            <div className="dz-message flex flex-col justify-center items-center text-center h-full gap-2">
                ...
                <div className="max-w-[400px]">
                    <h6 className="mb-2 text-sm text-gray dark:text-white/90">
